...
class SpatialController extends Controller
{
	...
	public function printPayload(Request $request)
	{
		$filters = [
			...
			'status' => $request->input('status_lahan'),
			'is_active' => $request->input('status_mitra'),
		];
	...
	public function renderPrintAllSpatials(Request $request)
	{
		...
		$template = view('t2024.spatial.spatialprints', ['payload' => $payload])->render();
		try {
			...
			return response($pdfContent)
				...
				->header('Content-Disposition', 'attachment; filename="daftar_spatials.pdf"');
		} catch (\Exception $e) {
