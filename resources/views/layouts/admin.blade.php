...
<html lang="en" class="root-text-sm">
	<head>
		...
		<script async defer src="https://maps.googleapis.com/maps/api/js?key={{ isset($mapkey) ? $mapkey->key : 'Default Key' }}&libraries=drawing,geometry,marker&loading=async" ></script>
