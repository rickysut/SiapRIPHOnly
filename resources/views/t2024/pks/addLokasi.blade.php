						...
						<div class="row d-flex flex-row justify-content-between">
								...
								<div class="">
									<div class="list-group">
										<a class="list-group-item list-group-item-action d-flex justify-content-between">
											...
											<span id="nama_petani">{{$data['anggota']->nama_petani}}</span>
										</a>
										<a class="list-group-item list-group-item-action d-flex justify-content-between" id="ktp_petani">
											<span>Nama Pengelola</span>
											<span id="ktp_petani">{{$data['anggota']->ktp_petani}}</span>
										</a>
									</div>
								</div>
							</div>
							<div class="col-md-8">
								<form action="" method="POST" enctype="multipart/form-data">
									...
									<input type="hidden" name="anggota_id" value="{{$data['spatial']->ktp_petani}}">
									<input type="hidden" name="lokasi_id" value="{{$data['anggota']->id}}">
									<div class="row">
									...
									<div class="row">
										<div class="col-md-5 mb-5">
											...
											<div class="form-group">
												<label>Luas Area (ha)<sup class="text-info"> *</sup></label>
												<div class="input-group">
													<div class="input-group-prepend">
