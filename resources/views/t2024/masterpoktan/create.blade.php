						...
						<form action="">
							<div class="form-group row">
								<div class="col-12">
									...
									<input type="text" id="nama_kelompok" name="nama_kelompok"  class="form-control @error('nama_kelompok') is-invalid @enderror" placeholder="nama kelompok tani" value="" required>
							...
							<div class="form-group row">
								<div class="col-md-6">
									...
									<input id="nama_pimpinan" type="nama_pimpinan" class="form-control @error('nama_pimpinan') is-invalid @enderror" placeholder="nama pimpinan kelompok tani" name="nama_pimpinan" value="" required>
								...
								<div class="col-md-6">
									...
									<input type="text" id="hp_pimpinan" name="hp_pimpinan" class="form-control @error('hp_pimpinan') is-invalid @enderror" placeholder="No. Handphone" value="" required>
